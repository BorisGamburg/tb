class StructureDetector:
    ...
    def is_break_down(self, tf: str) -> bool:
    ...
    def is_entry(self, tf: str, side: str) -> bool:
        """
        Entry = пробой в сторону позиции
        """

        if side == "Buy":
            return self.is_break_up(tf)

        if side == "Sell":
            return self.is_break_down(tf)
    ...
    def is_break_up(self, tf: str) -> bool:
